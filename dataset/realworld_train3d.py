...
class RealWorldDataset(Dataset):
    ...
    def _validate_mask_aware_config(self):
        ...
        # train_3donly: 仅放行 (3d=true,2d=true) 与 (3d=true,2d=false)
        if not self.mask_enable_3d_filter:
            raise ValueError("train_3donly requires enable_3d_filter=true")
    ...
    def __getitem__(self, index):
        ...
        if self.mask_aware_enabled:
            ...
            # 仅在开启 2D 重权重时生成 patch 级可信度
            if self.mask_enable_2d_reweight:
