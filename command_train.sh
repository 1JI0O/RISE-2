...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --master_addr 127.0.0.1 --master_port 23333 --nproc_per_node 4 --nnodes 1 --node_rank 0 train.py --data_path /data/haoxiang/data/airexo2/task_0013 --ckpt_dir /data/haoxiang/logs/airexo_task0013_original --config configs/dual_teleop_dino.yaml
